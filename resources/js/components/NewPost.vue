    ...
    <div class="bg-white rounded shadow w-2/3 p-4">
        <div class="flex justify-between items-center">
            ...
            <div class="flex-1 flex mx-2">
                <input
                    v-model="postMessage"
                    class="w-full h-8 pl-4 bg-gray-200 rounded-full focus:outline-none focus:shadow-outline text-sm"
                    type="text"
                    name="body"
                    id="body"
                ...
                <transition name="fade">
                    <button
                        v-if="postMessage"
                        @click="postHandler"
                        class="bg-gray-200 ml-2 px-3 py-1 rounded-full focus:outline-none focus:shadow-outline"
                    >
                        Post
                    </button>
                </transition>
            ...
            <div>
                <button
                    class="dz-clickable flex justify-center items-center bg-gray-200 rounded-full w-10 h-10 text-gray-600 focus:outline-none focus:shadow-outline"
                    ref="postImage"
                >
                    <svg
            ...
            <div id="dz-template" class="hidden">
                <div class="dz-preview dz-file-preview mt-4">
                    <div class="dz-details">
                        <img data-dz-thumbnail class="w-32 h-32 rounded">
    ...
    methods: {
        postHandler() {
            if(this.dropzone.getAcceptedFiles().length) {
                ...
                this.$store.dispatch('submitPostMessage')
            }
