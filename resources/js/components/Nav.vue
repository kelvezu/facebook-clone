<template>
    ...
    >
            ...
            <div class="flex">
                ...
                <div class="ml-2 relative">
                    <div class="absolute text-gray-700">
                        <svg
                            viewBox="0 0 24 24"
                            class="w-5 h-5 mt-2 ml-2 fill-current"
                        >
                            <path
                                fill-rule="evenodd"
                    ...
                    <input
                        type="text"
                        class="w-56 pl-8 h-8 bg-gray-200 rounded-full focus:outline-none focus:shadow-outline text-sm"
                        name="search"
                        id="search"
        ...
        <div class="w-1/3 flex justify-center items-center h-full">
            <router-link
                class="px-6 h-full border-b-2 border-white hover:border-blue-500 hover:text-blue-500 flex items-center"
                to="/"
            >
                <svg
                    xmlns="http://www.w3.org/2000/svg"
            ...
            <router-link
                ...
                :to="{
                    name: 'user.show',
                    params: { userId: authUser.data.user_id }
                }"
            >
                <img
